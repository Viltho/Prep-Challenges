...
function gradesAvg(arr) {
    // write your code here
    return arr.map(element => ({...element, avg: element.gradsList.reduce((a, b) => a + b, 0) / element.gradsList.length}));
}
// -------------------------------------------------------------------------------------------------------
...
function studentsResult(arr) {
    // write your code here
    const arrWithAvg = gradesAvg(arr);
    return arrWithAvg.map(element => ({...element, result: element.avg > 50 ? "Passed" : "Failed"}));
}
// -------------------------------------------------------------------------------------------------------
