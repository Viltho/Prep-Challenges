...
const cvsFiltration = (arr) => {
    // write your code here
    let x = arr.filter(data => data.yearsOfExperience > 4 && data.tech === "JS");
...
const vowelsFiltration = (arr) => {
    // write your code here
    let arrV = ["a", "e", "i", "o", "u"];
    let x = arr.filter((el) => {return !el.split("").some((char) => {return arrV.includes(char);});});
    return x;
}
// -------------------------------------------------------------------------------------------------------
...
const skillComparison = (arr1, arr2) => {
    ...
    let y = arr2.filter(e => !arr1.includes(e));
    return x.concat(y);
}
// -------------------------------------------------------------------------------------------------------
